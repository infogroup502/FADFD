...
if __name__ == '__main__':
    ...
    parser.add_argument('--win_size_1', type=int, default=12)  ####### 50  全局窗口长度
    parser.add_argument('--count', type=int, default=8)  #########30    必须为奇数
    parser.add_argument('--anormly_ratio', type=float, default=0.85)########## 5
    parser.add_argument('--p', type=float, default=0)  ########## 大窗口小窗口分数占比   p*点级别+(1-p)*子序列 1:点集 0:子序列
