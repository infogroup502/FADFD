...
class SVDBSegLoader(object):
    def __init__(self, data_path, win_size, win_size_1, count, step, mode="train"):
        ...
        self.win_size = win_size
        self.scaler = StandardScaler()
        data = np.load(data_path + "/SVDB" + "_train.npy")
        self.scaler.fit(data)
        data = self.scaler.transform(data)
        test_data = np.load(data_path + "/SVDB" + "_test.npy")
        self.test = self.scaler.transform(test_data)

        self.train = data
        self.val = self.test
        self.test_labels = np.load(data_path + "/SVDB" + "_test_label.npy")
        self.win_size_1 = win_size_1
        self.count = count
        if self.mode == "val":
            print("train:", self.train.shape)
...
class MITDBSegLoader(object):
    def __init__(self, data_path, win_size, win_size_1, count, step, mode="train"):
        ...
        self.win_size = win_size
        self.scaler = StandardScaler()
        data = np.load(data_path + "/MITDB" + "_train.npy")
        self.scaler.fit(data)
        data = self.scaler.transform(data)
        test_data = np.load(data_path + "/MITDB" + "_test.npy")
        self.test = self.scaler.transform(test_data)

        self.train = data
        self.val = self.test
        self.test_labels = np.load(data_path + "/MITDB" + "_test_label.npy")
        self.win_size_1 = win_size_1
        self.count = count
        if self.mode == "val":
            print("train:", self.train.shape)
...
class OccupancySegLoader(object):
    def __init__(self, data_path, win_size, win_size_1, count, step, mode="train"):
        self.mode = mode
        self.step = step
        ...
        self.win_size = win_size
        self.scaler = StandardScaler()
        data = np.load(data_path + "/Occupancy" + "_train.npy")
        self.scaler.fit(data)
        data = self.scaler.transform(data)
        test_data = np.load(data_path + "/Occupancy" + "_test.npy")
        self.test = self.scaler.transform(test_data)

        self.train = data
        self.val = self.test
        self.test_labels = np.load(data_path + "/Occupancy" + "_test_label.npy")
        self.win_size_1 = win_size_1
        self.count = count
        if self.mode == "val":
            print("train:", self.train.shape)
...
class ECGSegLoader(object):
    def __init__(self, data_path, win_size, win_size_1, count, step, mode="train"):
        ...
        self.win_size = win_size
        self.scaler = StandardScaler()
        data = np.load(data_path + "/ECG" + "_train.npy")
        self.scaler.fit(data)
        data = self.scaler.transform(data)
        test_data = np.load(data_path + "/ECG" + "_test.npy")
        self.test = self.scaler.transform(test_data)

        self.train = data
        self.val = self.test
        self.test_labels = np.load(data_path + "/ECG" + "_test_label.npy")
        self.win_size_1 = win_size_1
        self.count = count
        if self.mode == "val":
            print("train:", self.train.shape)
...
def get_loader_segment(index, data_path, batch_size, win_size_1, count, win_size=100, step=1, mode='train',
    ...
    if (dataset == 'SMD'):
        ...
        dataset = GECCOSegLoader(data_path, win_size, win_size_1, count, 1, mode)
    elif (dataset == 'SVDB'):
        dataset = SVDBSegLoader(data_path, win_size, win_size_1, count, 1, mode)
    elif (dataset == 'MITDB'):
        dataset = MITDBSegLoader(data_path, win_size, win_size_1, count, 1, mode)
    elif (dataset == 'Occupancy'):
        dataset = OccupancySegLoader(data_path, win_size, win_size_1, count, 1, mode)
    elif (dataset == 'ECG'):
        dataset = ECGSegLoader(data_path, win_size, win_size_1, count, 1, mode)
